...
def create_new_bot(title):
    ...
    bot = window_control.Window(title, 'k', horizontal_blocks=int(horizontal_blocks.get()), vertical_blocks=int(vertical_blocks.get()))
    bots[title] = bot
...
data = [("Element 1", "Akcja 1"), ("Element 2", "Akcja 2"), ("Element 3", "Akcja 3")]
